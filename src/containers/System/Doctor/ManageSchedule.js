...
import { flatMap, range, result } from 'lodash';
...
class ManageSchedule extends Component {
    ...
    handleSaveSchedule = async () => {
        ...
        if (res && res.errCode === 0) {
            toast.success('Save Bulk Schedule Success')
        } else {
            toast.error('Save Bulk Schedule Failed')
        }
        console.log('check response ', res)
        console.log('check SavebulkSchedule ', result)
                    ...
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-6 form-group'>
                                ...
                                <DatePicker
                                    onChange={(data) => this.handleOnchangeDatePicker(data)}
                            ...
                            <div className='col-12'>
                                <button className='btn-primary btn btn-save-schedule'
